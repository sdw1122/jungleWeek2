...
document.querySelector('#login-form').addEventListener('submit',event=>{event.preventDefault();toast.textContent='로그인되었습니다. 식물을 선택해 주세요.';toast.classList.add('show');setTimeout(()=>location.href='plant-select.html',650)});
