...
document.querySelector('#login-form').addEventListener('submit',event=>{event.preventDefault();toast.textContent='로그인되었습니다. 상태창으로 이동합니다.';toast.classList.add('show');setTimeout(()=>location.href='dashboard.html',650)});
